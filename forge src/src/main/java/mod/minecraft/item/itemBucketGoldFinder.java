...
public class itemBucketGoldFinder extends ItemBucket{
    ...
    {
        boolean flag = this.isFilled == Blocks.air;
    ...
    public boolean tryPlaceContainedLiquid(World par1World, int par2, int par3, int par4)
    {
        ...
        else
        {
            ...
            {
                if (par1World.provider.isHellWorld && this.isFilled == Blocks.flowing_water)
                {
                ...
                else
                {
                    ...
                    par1World.setBlock(par2, par3, par4, this.isFilled, 0, 3);
                }
